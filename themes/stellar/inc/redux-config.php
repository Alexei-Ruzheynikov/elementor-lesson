...
$opt_name = 'stellaroptions';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer Fields', 'your-textdomain-here' ),
		'id'               => 'footer',
...
Redux::setSection( $opt_name, array(
        'title'            => __( 'About Info', 'redux-framework-demo' ),
        'id'               => 'footer-info',
        'subsection'       => true,
